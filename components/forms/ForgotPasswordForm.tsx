      ...
      return (
          <div className="flex flex-col items-center justify-center space-y-6 animate-in fade-in zoom-in duration-500 pt-4">
              ...
              <div className="space-y-2 text-center">
                  <h2 className="text-24-bold text-primary dark:text-white">Check your email</h2>
                  <p className="text-16-medium text-black-1/60 dark:text-white/60 max-w-sm mx-auto">
                      We sent a password reset link to <br />
                      <span className="font-semibold text-primary dark:text-white">{form.getValues("email")}</span>
                  </p>
              </div>
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-full">
        ...
        <Button asChild variant="link" className="w-full text-black-1/50 dark:text-white/50">

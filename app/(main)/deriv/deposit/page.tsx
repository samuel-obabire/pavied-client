...
const DerivDepositPage = async () => {
  ...
  const rateRes = await fetchRates()

  return (
    <div className="w-full justify-between gap-4 space-y-6 overflow-y-auto md:pr-15 md:pl-10 lg:flex ">
      <div className="grow space-y-3">
        ...
        <section className="max-w-lg space-y-1">
          <DepositFlow
